...
const animalsCopy = [...animals, 'elephants']
...
let teachStay = teachTrick(stay).bind(fido)
...
let fidoIntro = dogIntro('chicken', 'tennis ball').apply(fido);
...
//CODE HERE
let phone1 = new Phone('Motorolla', '7S', 5, 'black', false)

let phone2 = new Phone('Sprint', 'Blueberry', 8, 'blue', false)

let phone3 = new Phone('ZackMorris', 'Brick', 0.5, 'beige', false)
